...
namespace Saphira.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "First,Last,Middle,PrimaryPhone,SecondaryPhone,Email,PayRate,Shift,StartDate,EndDate,FullTime,Volunteer")] Employee employee)
        {
            if (ModelState.IsValid)
            {
                //employee.ID = db.Employees.Max(emp => emp.ID) + 1 ;
